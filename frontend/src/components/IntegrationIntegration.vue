<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text style="background-color: white;">
            ...
            <String label="결과코드" v-model="value.결과코드" :editMode="editMode" :inputUI="''"/>
            <String label="결과메시지" v-model="value.결과메시지" :editMode="editMode" :inputUI="''"/>
            <Date label="송신일시" v-model="value.송신일시" :editMode="editMode" :inputUI="''"/>
            <Date label="수신일시" v-model="value.수신일시" :editMode="editMode" :inputUI="''"/>
        ...
        methods: {
            ...
            async save(){
                try {
                    ...
                    if(!this.offline) {
                        if(this.isNew) {
                            temp = await axios.post(axios.fixUrl('/integrations'), this.value)
                        } else {
